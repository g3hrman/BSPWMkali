...
sudo apt install -y kitty feh scrot scrub rofi xclip bat locate ranger neofetch wmname acpi bspwm sxhkd imagemagick cmatrix firejail seclists gobuster moreutils build-essential sshpass xxd
...
mkdir ~/Wallpapers
cp -v $ruta/Wallpaper/* ~/Wallpapers
mkdir ~/ScreenShots
